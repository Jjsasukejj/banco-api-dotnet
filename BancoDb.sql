...
CREATE TABLE [Cuentas] (
    ...
    [ClienteDbId] int NOT NULL,
    CONSTRAINT [PK_Cuentas] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_Cuentas_Clientes_ClienteDbId] FOREIGN KEY ([ClienteDbId]) REFERENCES [Clientes] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE INDEX [IX_Cuentas_ClienteDbId] ON [Cuentas] ([ClienteDbId]);
GO
...
VALUES (N'20260115055710_InitialCleanSchema', N'8.0.0');
GO
